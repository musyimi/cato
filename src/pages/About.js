...
const About = () => {
  return (
    <div className="relative">
      <div>
        <img
          className=" h-96 w-full object-cover opacity-40"
          src={Us}
          alt="about us"
        />
      </div>
      <div>
        <p className="xs:p-2 absolute lg1:top-24 lg1:text-center lg1:text-3xl lg1:font-semibold lg1:mx-10 text-gray-900">
